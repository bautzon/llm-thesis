...
async function main() {
    ...
    for (let i = 0; i < 100; i++) {
        let res = await generate();
            ...
            fs.writeFileSync("output_chatGpt_prompt2_student.json", JSON.stringify(answers, null, 4));
    }
}
